...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES["file"])) {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO dokumen (username, tipeDokumen, namaDokumen, tglUpload, waktu) VALUES ('$name', '$file_type', '" . $conn->real_escape_string(basename($_FILES["file"]["name"])) . "', NOW(), NOW())";
