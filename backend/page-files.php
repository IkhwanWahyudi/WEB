...
$hasil = mysqli_query($conn, "SELECT * FROM akun WHERE username='$username_'");
...
if(isset($_POST['keyword'])){
    ...
    $feedback = cariDokumen($_POST['keyword'], $name);
} else {
    $query = mysqli_query($conn,"SELECT * FROM dokumen WHERE username = '$name'");
        ...
        <div class="iq-sidebar  sidebar-default ">
            ...
            <div class="data-scrollbar" data-scroll="1">
                <div class="new-create select-dropdown input-prepend input-append">
                    <div class="btn-group">
                            <div class="search-query selet-caption"><a href="add_file.php?username=<?php echo $name; ?>"><i class="las la-plus pr-2"></i>Tambah</a></div><span class="search-replace" ></span>
                                        ...
                                        <div class="card-body">
                                            <div class="profile-header">
                                                <div class="cover-container text-center">
                                                    ...
                                                    <a href="auth-sign-out.php" class="btn btn-primary">Sign Out</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <i class="ri-file-excel-line"></i>
                                                                        ...
                                                                        <!-- BUAT LIAT FILENYA -->
                                                                        <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="<?php echo $filepath ?>" data-toggle="modal" data-target="#exampleModal" data-title="<?php echo $kmn["namaDokumen"];?>" style="cursor: pointer;">
                                                                            <?php echo $kmn["namaDokumen"];?>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton10">
                                                                            <a class="dropdown-item" href="unduh_file.php?id=<?=$kmn['id'];?>"><i class="ri-file-download-fill mr-2"></i>Unduh File</a>
                                                                            <a class="dropdown-item" href="rename.php?id=<?=$kmn['id']?>namabaru=<?=$kmn['namaDokumen']?>&username=<?php echo $name; ?>"><i class="ri-pencil-fill mr-2"></i>Ubah Nama</a>
                                                                            <a class="dropdown-item" href="delete_file.php?id=<?=$kmn['id'];?>&username=<?php echo $name; ?>"><i class="ri-delete-bin-6-fill mr-2"></i>Hapus</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
