                                ...
                                <form method="POST" action="">
                                    <div class="input-prepend input-append">
                                        <label class="dropdown-toggle searchbox" name="search" data-toggle="dropdown">
                                            <input class="dropdown-toggle search-query text search-input" name="keyword"
                                                type="text" placeholder="Cari file..."><span class="search-replace"></span>
                                                                    ...
                                                                    <i class="ri-file-excel-line"></i>
                                                                        ...
                                                                        <?php if (in_array($kmn["tipeDokumen"], array('txt', "jpg", "jpeg", "bmp", "gif", "png", "mp4", "avi", "mov", "mp3"))): ?>
                                                                            <a href="<?php echo $filepath ?>"
                                                                                style="text-decoration: none; color: #535f6b;">
                                                                                <?php echo $namafile; ?>
                                                                            </a>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="unduh_file.php?id=<?= $kmn['id']; ?>"><i
                                                                                    class="ri-file-download-fill mr-2"></i>Unduh
                                                                                File</a>
                                                                            <a class="dropdown-item"
                                                                                href="rename.php?id=<?= $kmn['id'] ?>"><i
                                                                                    class="ri-pencil-fill mr-2"></i>Ubah Nama</a>
                                                                            <a class="dropdown-item"
                                                                                href="delete_file.php?id=<?= $kmn['id']; ?>"><i
                                                                                    class="ri-delete-bin-6-fill mr-2"></i>Hapus</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
