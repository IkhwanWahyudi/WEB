        ...
        <div class="iq-sidebar  sidebar-default ">
            ...
            <div class="data-scrollbar" data-scroll="1">
                <div class="new-create select-dropdown input-prepend input-append">
                    <div class="btn-group">
                            <div class="search-query selet-caption"><a href="add_file.php?username=<?php echo $username['username']; ?>"><i class="las la-plus pr-2"></i>Tambah</a></div><span class="search-replace" ></span>
                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="active">
                            <a href="page-files.php?username=<?php echo $username['username']; ?>" class="">
                                            ...
                                            <div class="profile-header">
                                                <div class="cover-container text-center">
                                                    ...
                                                    <div class="profile-detail mt-3">
                                                        ...
                                                        <h5><?php echo $username['username']; ?></a>
                                                        </h5>
                                                        <p> 
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton10">
                                                                            ...
                                                                            <a class="dropdown-item" href="rename.php?id=<?=$kmn['id']?>namabaru=<?=$kmn['namaDokumen']?>"><i class="ri-pencil-fill mr-2"></i>Ubah Nama</a>
