...
function verifikasi_email($email, $kode_otp)
{
   ...
   try {
      $post = array(
         'from' => 'vulcan.ryujin.9@gmail.com',
...
<body class=" ">
                  ...
                  <div class="sign-user_card">
                     ...
                     <form action="auth-sign-up.php" method="post" onsubmit="return validateInput()">
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <div class="floating-label form-group">
                                 <input class="floating-input form-control" type="password" name="konfirpassword"
                                    placeholder=" ">
                           ...
                           <div class="col-lg-12">
                              <div class="custom-control custom-checkbox mb-3 text-left">
                                 ...
                                 <label class="custom-control-label" for="customCheck1">Saya setuju dengan <a
                                       href=snk.php>syarat & ketentuan penggunaan</label>
                              </div>
                           </div>
                        </div>
                        <button type="submit" name="register" class="btn btn-primary" id="myButton" disabled>Sign
                           Up</button>
                        <p class="mt-3">Sudah memiliki akun? <a href="auth-sign-in.php" class="text-primary">Sign In</a>
                        </p>
                     </form>
                  </div>
               </div>
   ...
   <script>
      // Mendapatkan referensi elemen checkbox dan tombol
